...
result_0 = 128*helper_0*y - 80*helper_0 + 128*helper_1*x - 80*helper_1 + (128.0/3.0)*pow(x, 3) - 160*x*y + (140.0/3.0)*x + (128.0/3.0)*pow(y, 3) + (140.0/3.0)*y - 25.0/3.0;val.col(1) = result_0; }} break;
	...
	case 3: {{const auto helper_0 = 24*y;
const auto helper_1 = pow(x, 2);
const auto helper_2 = pow(y, 2);
result_0 = -16*helper_0*helper_1 + 16*helper_0*x + 288*helper_1 - 256*helper_2*x + 96*helper_2 - 512.0/3.0*pow(x, 3) - 416.0/3.0*x - 128.0/3.0*pow(y, 3) - 208.0/3.0*y + 16;val.col(0) = result_0; }{result_0 = -16.0/3.0*x*(24*pow(x, 2) + 48*x*y - 36*x + 24*pow(y, 2) - 36*y + 13);val.col(1) = result_0; }} break;
...
result_0 = 128*helper_0*y - 16*helper_0 + 4*helper_1*x - 4*helper_1 - 288*x*y + 28*x + 256*pow(y, 3) + 152*y - 12;val.col(1) = result_0; }} break;
	case 11: {{result_0 = -16.0/3.0*y*(24*pow(x, 2) + 48*x*y - 36*x + 24*pow(y, 2) - 36*y + 13);val.col(0) = result_0; }{const auto helper_0 = 24*x;
const auto helper_1 = pow(x, 2);
const auto helper_2 = pow(y, 2);
result_0 = -16*helper_0*helper_2 + 16*helper_0*y - 256*helper_1*y + 96*helper_1 + 288*helper_2 - 128.0/3.0*pow(x, 3) - 208.0/3.0*x - 512.0/3.0*pow(y, 3) - 416.0/3.0*y + 16;val.col(1) = result_0; }} break;
...
switch(local_index){
	case 0: {const auto helper_0 = 18*x;
...
result_0 = helper_0*y + helper_0*z - 27*helper_1*x + 18*helper_1 - helper_2*helper_6 - helper_2*helper_7 + 9*helper_2 - helper_3*helper_5 - helper_3*helper_7 + 9*helper_3 - helper_4*helper_5 - helper_4*helper_6 + 9*helper_4 - 9.0/2.0*pow(x, 3) - 11.0/2.0*x - 9.0/2.0*pow(y, 3) - 11.0/2.0*y - 9.0/2.0*pow(z, 3) - 11.0/2.0*z + 1;} break;
	case 1: {result_0 = (1.0/2.0)*x*(9*pow(x, 2) - 9*x + 2);} break;
	case 2: {result_0 = (1.0/2.0)*y*(9*pow(y, 2) - 9*y + 2);} break;
...
result_0 = (1.0/3.0)*helper_0*(3*pow(helper_0, 3) + helper_1*helper_8 + 18*helper_1*z + helper_10*x + helper_10*y + helper_10*z + helper_11*helper_2 + helper_11*helper_4 + helper_11*helper_5 + helper_2*helper_3 + helper_2*helper_7 + helper_3*helper_4 + helper_4*helper_6 + helper_5*helper_6 + helper_5*helper_7 + helper_9*x + helper_9*y + 3*pow(x, 3) + 3*pow(y, 3) + 3*pow(z, 3));} break;
	case 1: {result_0 = (1.0/3.0)*x*(32*pow(x, 3) - 48*pow(x, 2) + 22*x - 3);} break;
	case 2: {result_0 = (1.0/3.0)*y*(32*pow(y, 3) - 48*pow(y, 2) + 22*y - 3);} break;
	case 3: {result_0 = (1.0/3.0)*z*(32*pow(z, 3) - 48*pow(z, 2) + 22*z - 3);} break;
	case 4: {const auto helper_0 = 36*x;
const auto helper_1 = y*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = pow(z, 2);
...
result_0 = -16.0/3.0*x*(-helper_0*y - helper_0*z + 48*helper_1*x - 36*helper_1 + helper_2*helper_6 + helper_2*helper_7 - 18*helper_2 + helper_3*helper_5 + helper_3*helper_7 - 18*helper_3 + helper_4*helper_5 + helper_4*helper_6 - 18*helper_4 + 8*pow(x, 3) + 13*x + 8*pow(y, 3) + 13*y + 8*pow(z, 3) + 13*z - 3);} break;
	case 5: {const auto helper_0 = 2*y;
const auto helper_1 = 2*z;
const auto helper_2 = x + y + z - 1;
const auto helper_3 = helper_2*x;
result_0 = 4*helper_3*(-helper_0*helper_2 + helper_0*x - helper_0*z - helper_1*helper_2 + helper_1*x + 3*pow(helper_2, 2) + 10*helper_3 + 3*pow(x, 2) - pow(y, 2) - pow(z, 2));} break;
	case 6: {const auto helper_0 = 6*x;
const auto helper_1 = pow(x, 2);
const auto helper_2 = 8*helper_1;
result_0 = -16.0/3.0*x*(-helper_0*y - helper_0*z - 14*helper_1 + helper_2*y + helper_2*z + 8*pow(x, 3) + 7*x + y + z - 1);} break;
	case 7: {result_0 = (16.0/3.0)*x*y*(8*pow(x, 2) - 6*x + 1);} break;
	case 8: {const auto helper_0 = 4*x;
result_0 = helper_0*y*(-helper_0 + 16*x*y - 4*y + 1);} break;
	case 9: {result_0 = (16.0/3.0)*x*y*(8*pow(y, 2) - 6*y + 1);} break;
	case 10: {const auto helper_0 = 6*y;
const auto helper_1 = pow(y, 2);
const auto helper_2 = 8*helper_1;
result_0 = -16.0/3.0*y*(-helper_0*x - helper_0*z - 14*helper_1 + helper_2*x + helper_2*z + x + 8*pow(y, 3) + 7*y + z - 1);} break;
	case 11: {const auto helper_0 = 2*y;
const auto helper_1 = 2*x;
const auto helper_2 = x + y + z - 1;
const auto helper_3 = helper_2*y;
result_0 = -4*helper_3*(-helper_0*x - helper_0*z + helper_1*helper_2 + helper_1*z - 3*pow(helper_2, 2) + 2*helper_2*z - 10*helper_3 + pow(x, 2) - 3*pow(y, 2) + pow(z, 2));} break;
	case 12: {const auto helper_0 = 36*x;
const auto helper_1 = y*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = pow(z, 2);
...
const auto helper_6 = 24*y;
const auto helper_7 = 24*z;
result_0 = -16.0/3.0*y*(-helper_0*y - helper_0*z + 48*helper_1*x - 36*helper_1 + helper_2*helper_6 + helper_2*helper_7 - 18*helper_2 + helper_3*helper_5 + helper_3*helper_7 - 18*helper_3 + helper_4*helper_5 + helper_4*helper_6 - 18*helper_4 + 8*pow(x, 3) + 13*x + 8*pow(y, 3) + 13*y + 8*pow(z, 3) + 13*z - 3);} break;
	case 13: {const auto helper_0 = 36*x;
const auto helper_1 = y*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = pow(z, 2);
...
const auto helper_6 = 24*y;
const auto helper_7 = 24*z;
result_0 = -16.0/3.0*z*(-helper_0*y - helper_0*z + 48*helper_1*x - 36*helper_1 + helper_2*helper_6 + helper_2*helper_7 - 18*helper_2 + helper_3*helper_5 + helper_3*helper_7 - 18*helper_3 + helper_4*helper_5 + helper_4*helper_6 - 18*helper_4 + 8*pow(x, 3) + 13*x + 8*pow(y, 3) + 13*y + 8*pow(z, 3) + 13*z - 3);} break;
	case 14: {const auto helper_0 = 2*x;
const auto helper_1 = 2*z;
const auto helper_2 = x + y + z - 1;
const auto helper_3 = helper_2*z;
result_0 = -4*helper_3*(helper_0*helper_2 + helper_0*y - helper_1*x - helper_1*y - 3*pow(helper_2, 2) + 2*helper_2*y - 10*helper_3 + pow(x, 2) + pow(y, 2) - 3*pow(z, 2));} break;
	case 15: {const auto helper_0 = 6*z;
const auto helper_1 = pow(z, 2);
const auto helper_2 = 8*helper_1;
result_0 = -16.0/3.0*z*(-helper_0*x - helper_0*y - 14*helper_1 + helper_2*x + helper_2*y + x + y + 8*pow(z, 3) + 7*z - 1);} break;
	case 16: {result_0 = (16.0/3.0)*x*z*(8*pow(x, 2) - 6*x + 1);} break;
	case 17: {const auto helper_0 = 4*x;
result_0 = helper_0*z*(-helper_0 + 16*x*z - 4*z + 1);} break;
	case 18: {result_0 = (16.0/3.0)*x*z*(8*pow(z, 2) - 6*z + 1);} break;
	case 19: {result_0 = (16.0/3.0)*y*z*(8*pow(y, 2) - 6*y + 1);} break;
	case 20: {const auto helper_0 = 4*y;
result_0 = helper_0*z*(-helper_0 + 16*y*z - 4*z + 1);} break;
	case 21: {result_0 = (16.0/3.0)*y*z*(8*pow(z, 2) - 6*z + 1);} break;
	case 22: {result_0 = 32*x*y*(x + y + z - 1)*(4*x + 4*y + 4*z - 3);} break;
	case 23: {result_0 = -32*x*y*(4*y - 1)*(x + y + z - 1);} break;
	case 24: {result_0 = -32*x*y*(4*x - 1)*(x + y + z - 1);} break;
	case 25: {result_0 = 32*x*z*(x + y + z - 1)*(4*x + 4*y + 4*z - 3);} break;
	case 26: {result_0 = -32*x*z*(4*z - 1)*(x + y + z - 1);} break;
	case 27: {result_0 = -32*x*z*(4*x - 1)*(x + y + z - 1);} break;
	case 28: {result_0 = 32*x*y*z*(4*x - 1);} break;
	case 29: {result_0 = 32*x*y*z*(4*z - 1);} break;
	case 30: {result_0 = 32*x*y*z*(4*y - 1);} break;
	case 31: {result_0 = -32*y*z*(4*y - 1)*(x + y + z - 1);} break;
	case 32: {result_0 = -32*y*z*(4*z - 1)*(x + y + z - 1);} break;
	case 33: {result_0 = 32*y*z*(x + y + z - 1)*(4*x + 4*y + 4*z - 3);} break;
	case 34: {result_0 = -256*x*y*z*(x + y + z - 1);} break;
	default: assert(false);
}}
...
val.resize(uv.rows(), uv.cols());
 Eigen::ArrayXd result_0(uv.rows());
switch(local_index){
	case 0: {{const auto helper_0 = 160*x;
const auto helper_1 = y*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = pow(z, 2);
...
result_0 = -helper_0*y - helper_0*z + 256*helper_1*x - 160*helper_1 + helper_2*helper_6 + helper_2*helper_7 - 80*helper_2 + helper_3*helper_5 + helper_3*helper_7 - 80*helper_3 + helper_4*helper_5 + helper_4*helper_6 - 80*helper_4 + (128.0/3.0)*pow(x, 3) + (140.0/3.0)*x + (128.0/3.0)*pow(y, 3) + (140.0/3.0)*y + (128.0/3.0)*pow(z, 3) + (140.0/3.0)*z - 25.0/3.0;val.col(2) = result_0; }} break;
	case 1: {{result_0 = (128.0/3.0)*pow(x, 3) - 48*pow(x, 2) + (44.0/3.0)*x - 1;val.col(0) = result_0; }{result_0.setZero();val.col(1) = result_0; }{result_0.setZero();val.col(2) = result_0; }} break;
	case 2: {{result_0.setZero();val.col(0) = result_0; }{result_0 = (128.0/3.0)*pow(y, 3) - 48*pow(y, 2) + (44.0/3.0)*y - 1;val.col(1) = result_0; }{result_0.setZero();val.col(2) = result_0; }} break;
	case 3: {{result_0.setZero();val.col(0) = result_0; }{result_0.setZero();val.col(1) = result_0; }{result_0 = (128.0/3.0)*pow(z, 3) - 48*pow(z, 2) + (44.0/3.0)*z - 1;val.col(2) = result_0; }} break;
	case 4: {{const auto helper_0 = 24*x;
const auto helper_1 = y*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = pow(z, 2);
...
result_0 = 16*helper_0*y + 16*helper_0*z - 512*helper_1*x + 192*helper_1 + 288*helper_2 - 16*helper_3*helper_5 - 128*helper_3*z + 96*helper_3 - 16*helper_4*helper_5 - 128*helper_4*y + 96*helper_4 - 16*helper_6*y - 16*helper_6*z - 512.0/3.0*pow(x, 3) - 416.0/3.0*x - 128.0/3.0*pow(y, 3) - 208.0/3.0*y - 128.0/3.0*pow(z, 3) - 208.0/3.0*z + 16;val.col(0) = result_0; }{const auto helper_0 = 48*x;
result_0 = -16.0/3.0*x*(helper_0*y + helper_0*z + 24*pow(x, 2) - 36*x + 24*pow(y, 2) + 48*y*z - 36*y + 24*pow(z, 2) - 36*z + 13);val.col(1) = result_0; }{const auto helper_0 = 48*x;
result_0 = -16.0/3.0*x*(helper_0*y + helper_0*z + 24*pow(x, 2) - 36*x + 24*pow(y, 2) + 48*y*z - 36*y + 24*pow(z, 2) - 36*z + 13);val.col(2) = result_0; }} break;
	case 5: {{const auto helper_0 = 72*x;
const auto helper_1 = y*z;
const auto helper_2 = 96*pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = pow(z, 2);
const auto helper_5 = 32*x;
result_0 = -4*helper_0*y - 4*helper_0*z + 256*helper_1*x - 32*helper_1 + 4*helper_2*y + 4*helper_2*z - 4*helper_2 + 4*helper_3*helper_5 - 16*helper_3 + 4*helper_4*helper_5 - 16*helper_4 + 256*pow(x, 3) + 152*x + 28*y + 28*z - 12;val.col(0) = result_0; }{const auto helper_0 = 32*x;
result_0 = 4*x*(helper_0*y + helper_0*z + 32*pow(x, 2) - 36*x - 8*y - 8*z + 7);val.col(1) = result_0; }{const auto helper_0 = 32*x;
result_0 = 4*x*(helper_0*y + helper_0*z + 32*pow(x, 2) - 36*x - 8*y - 8*z + 7);val.col(2) = result_0; }} break;
	case 6: {{const auto helper_0 = 4*x;
const auto helper_1 = pow(x, 2);
const auto helper_2 = 8*helper_1;
result_0 = 16*helper_0*y + 16*helper_0*z + 224*helper_1 - 16*helper_2*y - 16*helper_2*z - 512.0/3.0*pow(x, 3) - 224.0/3.0*x - 16.0/3.0*y - 16.0/3.0*z + 16.0/3.0;val.col(0) = result_0; }{result_0 = -16.0/3.0*x*(8*pow(x, 2) - 6*x + 1);val.col(1) = result_0; }{result_0 = -16.0/3.0*x*(8*pow(x, 2) - 6*x + 1);val.col(2) = result_0; }} break;
	case 7: {{result_0 = (16.0/3.0)*y*(24*pow(x, 2) - 12*x + 1);val.col(0) = result_0; }{result_0 = (16.0/3.0)*x*(8*pow(x, 2) - 6*x + 1);val.col(1) = result_0; }{result_0.setZero();val.col(2) = result_0; }} break;
	case 8: {{const auto helper_0 = 4*y;
result_0 = helper_0*(-helper_0 + 32*x*y - 8*x + 1);val.col(0) = result_0; }{const auto helper_0 = 4*x;
result_0 = helper_0*(-helper_0 + 32*x*y - 8*y + 1);val.col(1) = result_0; }{result_0.setZero();val.col(2) = result_0; }} break;
	case 9: {{result_0 = (16.0/3.0)*y*(8*pow(y, 2) - 6*y + 1);val.col(0) = result_0; }{result_0 = (16.0/3.0)*x*(24*pow(y, 2) - 12*y + 1);val.col(1) = result_0; }{result_0.setZero();val.col(2) = result_0; }} break;
	case 10: {{result_0 = -16.0/3.0*y*(8*pow(y, 2) - 6*y + 1);val.col(0) = result_0; }{const auto helper_0 = 4*y;
const auto helper_1 = pow(y, 2);
const auto helper_2 = 8*helper_1;
result_0 = 16*helper_0*x + 16*helper_0*z + 224*helper_1 - 16*helper_2*x - 16*helper_2*z - 16.0/3.0*x - 512.0/3.0*pow(y, 3) - 224.0/3.0*y - 16.0/3.0*z + 16.0/3.0;val.col(1) = result_0; }{result_0 = -16.0/3.0*y*(8*pow(y, 2) - 6*y + 1);val.col(2) = result_0; }} break;
	case 11: {{const auto helper_0 = 32*y;
result_0 = 4*y*(helper_0*x + helper_0*z - 8*x + 32*pow(y, 2) - 36*y - 8*z + 7);val.col(0) = result_0; }{const auto helper_0 = 72*y;
const auto helper_1 = x*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = 96*pow(y, 2);
const auto helper_4 = pow(z, 2);
const auto helper_5 = 32*y;
result_0 = -4*helper_0*x - 4*helper_0*z + 256*helper_1*y - 32*helper_1 + 4*helper_2*helper_5 - 16*helper_2 + 4*helper_3*x + 4*helper_3*z - 4*helper_3 + 4*helper_4*helper_5 - 16*helper_4 + 28*x + 256*pow(y, 3) + 152*y + 28*z - 12;val.col(1) = result_0; }{const auto helper_0 = 32*y;
result_0 = 4*y*(helper_0*x + helper_0*z - 8*x + 32*pow(y, 2) - 36*y - 8*z + 7);val.col(2) = result_0; }} break;
	case 12: {{const auto helper_0 = 48*x;
result_0 = -16.0/3.0*y*(helper_0*y + helper_0*z + 24*pow(x, 2) - 36*x + 24*pow(y, 2) + 48*y*z - 36*y + 24*pow(z, 2) - 36*z + 13);val.col(0) = result_0; }{const auto helper_0 = 24*y;
const auto helper_1 = x*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = pow(z, 2);
...
result_0 = 16*helper_0*x + 16*helper_0*z - 512*helper_1*y + 192*helper_1 - 16*helper_2*helper_6 - 128*helper_2*z + 96*helper_2 + 288*helper_3 - 16*helper_4*helper_6 - 128*helper_4*x + 96*helper_4 - 16*helper_5*x - 16*helper_5*z - 128.0/3.0*pow(x, 3) - 208.0/3.0*x - 512.0/3.0*pow(y, 3) - 416.0/3.0*y - 128.0/3.0*pow(z, 3) - 208.0/3.0*z + 16;val.col(1) = result_0; }{const auto helper_0 = 48*x;
result_0 = -16.0/3.0*y*(helper_0*y + helper_0*z + 24*pow(x, 2) - 36*x + 24*pow(y, 2) + 48*y*z - 36*y + 24*pow(z, 2) - 36*z + 13);val.col(2) = result_0; }} break;
	case 13: {{const auto helper_0 = 48*x;
result_0 = -16.0/3.0*z*(helper_0*y + helper_0*z + 24*pow(x, 2) - 36*x + 24*pow(y, 2) + 48*y*z - 36*y + 24*pow(z, 2) - 36*z + 13);val.col(0) = result_0; }{const auto helper_0 = 48*x;
result_0 = -16.0/3.0*z*(helper_0*y + helper_0*z + 24*pow(x, 2) - 36*x + 24*pow(y, 2) + 48*y*z - 36*y + 24*pow(z, 2) - 36*z + 13);val.col(1) = result_0; }{const auto helper_0 = x*y;
...
result_0 = -512*helper_0*z + 192*helper_0 + 16*helper_1*x + 16*helper_1*y - 16*helper_2*helper_6 - 128*helper_2*y + 96*helper_2 - 16*helper_3*helper_6 - 128*helper_3*x + 96*helper_3 + 288*helper_4 - 16*helper_5*x - 16*helper_5*y - 128.0/3.0*pow(x, 3) - 208.0/3.0*x - 128.0/3.0*pow(y, 3) - 208.0/3.0*y - 512.0/3.0*pow(z, 3) - 416.0/3.0*z + 16;val.col(2) = result_0; }} break;
	case 14: {{const auto helper_0 = 32*z;
result_0 = 4*z*(helper_0*x + helper_0*y - 8*x - 8*y + 32*pow(z, 2) - 36*z + 7);val.col(0) = result_0; }{const auto helper_0 = 32*z;
result_0 = 4*z*(helper_0*x + helper_0*y - 8*x - 8*y + 32*pow(z, 2) - 36*z + 7);val.col(1) = result_0; }{const auto helper_0 = x*y;
const auto helper_1 = 72*z;
const auto helper_2 = pow(x, 2);
const auto helper_3 = pow(y, 2);
const auto helper_4 = 96*pow(z, 2);
const auto helper_5 = 32*z;
result_0 = 256*helper_0*z - 32*helper_0 - 4*helper_1*x - 4*helper_1*y + 4*helper_2*helper_5 - 16*helper_2 + 4*helper_3*helper_5 - 16*helper_3 + 4*helper_4*x + 4*helper_4*y - 4*helper_4 + 28*x + 28*y + 256*pow(z, 3) + 152*z - 12;val.col(2) = result_0; }} break;
	case 15: {{result_0 = -16.0/3.0*z*(8*pow(z, 2) - 6*z + 1);val.col(0) = result_0; }{result_0 = -16.0/3.0*z*(8*pow(z, 2) - 6*z + 1);val.col(1) = result_0; }{const auto helper_0 = 4*z;
const auto helper_1 = pow(z, 2);
const auto helper_2 = 8*helper_1;
result_0 = 16*helper_0*x + 16*helper_0*y + 224*helper_1 - 16*helper_2*x - 16*helper_2*y - 16.0/3.0*x - 16.0/3.0*y - 512.0/3.0*pow(z, 3) - 224.0/3.0*z + 16.0/3.0;val.col(2) = result_0; }} break;
	case 16: {{result_0 = (16.0/3.0)*z*(24*pow(x, 2) - 12*x + 1);val.col(0) = result_0; }{result_0.setZero();val.col(1) = result_0; }{result_0 = (16.0/3.0)*x*(8*pow(x, 2) - 6*x + 1);val.col(2) = result_0; }} break;
	case 17: {{const auto helper_0 = 4*z;
result_0 = helper_0*(-helper_0 + 32*x*z - 8*x + 1);val.col(0) = result_0; }{result_0.setZero();val.col(1) = result_0; }{const auto helper_0 = 4*x;
result_0 = helper_0*(-helper_0 + 32*x*z - 8*z + 1);val.col(2) = result_0; }} break;
	case 18: {{result_0 = (16.0/3.0)*z*(8*pow(z, 2) - 6*z + 1);val.col(0) = result_0; }{result_0.setZero();val.col(1) = result_0; }{result_0 = (16.0/3.0)*x*(24*pow(z, 2) - 12*z + 1);val.col(2) = result_0; }} break;
	case 19: {{result_0.setZero();val.col(0) = result_0; }{result_0 = (16.0/3.0)*z*(24*pow(y, 2) - 12*y + 1);val.col(1) = result_0; }{result_0 = (16.0/3.0)*y*(8*pow(y, 2) - 6*y + 1);val.col(2) = result_0; }} break;
	case 20: {{result_0.setZero();val.col(0) = result_0; }{const auto helper_0 = 4*z;
result_0 = helper_0*(-helper_0 + 32*y*z - 8*y + 1);val.col(1) = result_0; }{const auto helper_0 = 4*y;
result_0 = helper_0*(-helper_0 + 32*y*z - 8*z + 1);val.col(2) = result_0; }} break;
	case 21: {{result_0.setZero();val.col(0) = result_0; }{result_0 = (16.0/3.0)*z*(8*pow(z, 2) - 6*z + 1);val.col(1) = result_0; }{result_0 = (16.0/3.0)*y*(24*pow(z, 2) - 12*z + 1);val.col(2) = result_0; }} break;
	case 22: {{const auto helper_0 = 16*x;
result_0 = 32*y*(helper_0*y + helper_0*z + 12*pow(x, 2) - 14*x + 4*pow(y, 2) + 8*y*z - 7*y + 4*pow(z, 2) - 7*z + 3);val.col(0) = result_0; }{const auto helper_0 = 16*y;
result_0 = 32*x*(helper_0*x + helper_0*z + 4*pow(x, 2) + 8*x*z - 7*x + 12*pow(y, 2) - 14*y + 4*pow(z, 2) - 7*z + 3);val.col(1) = result_0; }{result_0 = 32*x*y*(8*x + 8*y + 8*z - 7);val.col(2) = result_0; }} break;
	case 23: {{result_0 = -32*y*(8*x*y - 2*x + 4*pow(y, 2) + 4*y*z - 5*y - z + 1);val.col(0) = result_0; }{const auto helper_0 = 8*y;
result_0 = -32*x*(helper_0*x + helper_0*z - x + 12*pow(y, 2) - 10*y - z + 1);val.col(1) = result_0; }{result_0 = -32*x*y*(4*y - 1);val.col(2) = result_0; }} break;
	case 24: {{const auto helper_0 = 8*x;
result_0 = -32*y*(helper_0*y + helper_0*z + 12*pow(x, 2) - 10*x - y - z + 1);val.col(0) = result_0; }{result_0 = -32*x*(4*pow(x, 2) + 8*x*y + 4*x*z - 5*x - 2*y - z + 1);val.col(1) = result_0; }{result_0 = -32*x*y*(4*x - 1);val.col(2) = result_0; }} break;
	case 25: {{const auto helper_0 = 16*x;
result_0 = 32*z*(helper_0*y + helper_0*z + 12*pow(x, 2) - 14*x + 4*pow(y, 2) + 8*y*z - 7*y + 4*pow(z, 2) - 7*z + 3);val.col(0) = result_0; }{result_0 = 32*x*z*(8*x + 8*y + 8*z - 7);val.col(1) = result_0; }{const auto helper_0 = 16*z;
result_0 = 32*x*(helper_0*x + helper_0*y + 4*pow(x, 2) + 8*x*y - 7*x + 4*pow(y, 2) - 7*y + 12*pow(z, 2) - 14*z + 3);val.col(2) = result_0; }} break;
	case 26: {{result_0 = -32*z*(8*x*z - 2*x + 4*y*z - y + 4*pow(z, 2) - 5*z + 1);val.col(0) = result_0; }{result_0 = -32*x*z*(4*z - 1);val.col(1) = result_0; }{const auto helper_0 = 8*z;
result_0 = -32*x*(helper_0*x + helper_0*y - x - y + 12*pow(z, 2) - 10*z + 1);val.col(2) = result_0; }} break;
	case 27: {{const auto helper_0 = 8*x;
result_0 = -32*z*(helper_0*y + helper_0*z + 12*pow(x, 2) - 10*x - y - z + 1);val.col(0) = result_0; }{result_0 = -32*x*z*(4*x - 1);val.col(1) = result_0; }{result_0 = -32*x*(4*pow(x, 2) + 4*x*y + 8*x*z - 5*x - y - 2*z + 1);val.col(2) = result_0; }} break;
	case 28: {{result_0 = 32*y*z*(8*x - 1);val.col(0) = result_0; }{result_0 = 32*x*z*(4*x - 1);val.col(1) = result_0; }{result_0 = 32*x*y*(4*x - 1);val.col(2) = result_0; }} break;
	case 29: {{result_0 = 32*y*z*(4*z - 1);val.col(0) = result_0; }{result_0 = 32*x*z*(4*z - 1);val.col(1) = result_0; }{result_0 = 32*x*y*(8*z - 1);val.col(2) = result_0; }} break;
	case 30: {{result_0 = 32*y*z*(4*y - 1);val.col(0) = result_0; }{result_0 = 32*x*z*(8*y - 1);val.col(1) = result_0; }{result_0 = 32*x*y*(4*y - 1);val.col(2) = result_0; }} break;
	case 31: {{result_0 = -32*y*z*(4*y - 1);val.col(0) = result_0; }{const auto helper_0 = 8*y;
result_0 = -32*z*(helper_0*x + helper_0*z - x + 12*pow(y, 2) - 10*y - z + 1);val.col(1) = result_0; }{result_0 = -32*y*(4*x*y - x + 4*pow(y, 2) + 8*y*z - 5*y - 2*z + 1);val.col(2) = result_0; }} break;
	case 32: {{result_0 = -32*y*z*(4*z - 1);val.col(0) = result_0; }{result_0 = -32*z*(4*x*z - x + 8*y*z - 2*y + 4*pow(z, 2) - 5*z + 1);val.col(1) = result_0; }{const auto helper_0 = 8*z;
result_0 = -32*y*(helper_0*x + helper_0*y - x - y + 12*pow(z, 2) - 10*z + 1);val.col(2) = result_0; }} break;
	case 33: {{result_0 = 32*y*z*(8*x + 8*y + 8*z - 7);val.col(0) = result_0; }{const auto helper_0 = 16*y;
result_0 = 32*z*(helper_0*x + helper_0*z + 4*pow(x, 2) + 8*x*z - 7*x + 12*pow(y, 2) - 14*y + 4*pow(z, 2) - 7*z + 3);val.col(1) = result_0; }{const auto helper_0 = 16*z;
result_0 = 32*y*(helper_0*x + helper_0*y + 4*pow(x, 2) + 8*x*y - 7*x + 4*pow(y, 2) - 7*y + 12*pow(z, 2) - 14*z + 3);val.col(2) = result_0; }} break;
	case 34: {{result_0 = -256*y*z*(2*x + y + z - 1);val.col(0) = result_0; }{result_0 = -256*x*z*(x + 2*y + z - 1);val.col(1) = result_0; }{result_0 = -256*x*y*(x + y + 2*z - 1);val.col(2) = result_0; }} break;
	default: assert(false);
}}
