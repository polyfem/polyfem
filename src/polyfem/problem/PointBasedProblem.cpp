...
namespace polyfem
{
	...
	namespace problem
	{
		...
		void PointBasedTensorProblem::rhs(const assembler::Assembler &assembler, const std::string &formulation, const Eigen::MatrixXd &pts, const double t, Eigen::MatrixXd &val) const
		{
