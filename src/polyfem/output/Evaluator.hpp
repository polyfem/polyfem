...
namespace polyfem::output
{
	...
	public:
		...
		static void compute_vertex_values(int actual_dim, const std::vector<basis::ElementBases> &basis, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result);
		...
		static void compute_stress_at_quadrature_points(const Eigen::MatrixXd &fun, Eigen::MatrixXd &result, Eigen::VectorXd &von_mises);
		...
		static void interpolate_function(const int n_points, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result, const bool use_sampler, const bool boundary_only);
		/// interpolate the function fun.
		/// @param[in] n_points is the size of the output.
		/// @param[in] actual_dim is the size of the problem (e.g., 1 for Laplace, dim for elasticity)
		/// @param[in] basis basis function
		...
		/// @param[in] use_sampler uses the sampler or not
		/// @param[in] boundary_only interpolates only at boundary elements
		static void interpolate_function(const int n_points, const int actual_dim, const std::vector<basis::ElementBases> &basis, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result, const bool use_sampler, const bool boundary_only);
		...
		static void interpolate_at_local_vals(const int el_index, const Eigen::MatrixXd &local_pts, Eigen::MatrixXd &result, Eigen::MatrixXd &result_grad);
		/// interpolate solution and gradient at element (calls interpolate_at_local_vals with sol)
		/// @param[in] el_index element index
		/// @param[in] local_pts points in the reference element
		/// @param[in] fun function to used
		/// @param[out] result output
		/// @param[out] result_grad output gradients
		static void interpolate_at_local_vals(const int el_index, const Eigen::MatrixXd &local_pts, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result, Eigen::MatrixXd &result_grad);
		...
		/// @param[out] result output
		/// @param[out] result_grad output gradients
		static void interpolate_at_local_vals(const int el_index, const int actual_dim, const std::vector<basis::ElementBases> &bases, const Eigen::MatrixXd &local_pts, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result, Eigen::MatrixXd &result_grad);
		...
		/// @param[in] use_sampler uses the sampler or not
		/// @param[in] boundary_only interpolates only at boundary elements
		static void compute_scalar_value(const int n_points, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result, const bool use_sampler, const bool boundary_only);
		/// computes scalar quantity of funtion (ie von mises for elasticity and norm of velocity for fluid)
		...
		/// @param[in] use_sampler uses the sampler or not
		/// @param[in] boundary_only interpolates only at boundary elements
		static void average_grad_based_function(const int n_points, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result_scalar, Eigen::MatrixXd &result_tensor, const bool use_sampler, const bool boundary_only);
		...
		/// @param[in] use_sampler uses the sampler or not
		/// @param[in] boundary_only interpolates only at boundary elements
		static void compute_tensor_value(const int n_points, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result, const bool use_sampler, const bool boundary_only);
		...
		static void interpolate_boundary_function(const Eigen::MatrixXd &pts, const Eigen::MatrixXi &faces, const Eigen::MatrixXd &fun, const bool compute_avg, Eigen::MatrixXd &result);
		...
		/// @param[in] fun function to used
		/// @param[out] result resulting value
		static void interpolate_boundary_function_at_vertices(const Eigen::MatrixXd &pts, const Eigen::MatrixXi &faces, const Eigen::MatrixXd &fun, Eigen::MatrixXd &result);
		...
		static void interpolate_boundary_tensor_function(const Eigen::MatrixXd &pts, const Eigen::MatrixXi &faces, const Eigen::MatrixXd &fun, const Eigen::MatrixXd &disp, const bool compute_avg, Eigen::MatrixXd &result, Eigen::MatrixXd &stresses, Eigen::MatrixXd &mises, const bool skip_orientation = false);
		...
		/// @param[out] mises resulting mises
		/// @param[in] skip_orientation skip reorientation of surface
		static void interpolate_boundary_tensor_function(const Eigen::MatrixXd &pts, const Eigen::MatrixXi &faces, const Eigen::MatrixXd &fun, const bool compute_avg, Eigen::MatrixXd &result, Eigen::MatrixXd &stresses, Eigen::MatrixXd &mises, const bool skip_orientation = false);
		...
		static void get_sidesets(Eigen::MatrixXd &pts, Eigen::MatrixXi &faces, Eigen::MatrixXd &sidesets);

		/// samples to solution on the visualization mesh and return the vis mesh (points and tets) and the interpolated values (fun)
		static void get_sampled_solution(Eigen::MatrixXd &points, Eigen::MatrixXi &tets, Eigen::MatrixXd &fun, bool boundary_only = false)
		{
			// TODO: fix me TESEO
		...
		static void get_stresses(Eigen::MatrixXd &fun, bool boundary_only = false)
		{
			// TODO: fix me TESEO
		...
		static void get_sampled_mises(Eigen::MatrixXd &fun, bool boundary_only = false)
		{
			// TODO: fix me TESEO
			// Eigen::MatrixXd points;
			// Eigen::MatrixXi tets;
		...
		static void get_sampled_mises_avg(Eigen::MatrixXd &fun, Eigen::MatrixXd &tfun, bool boundary_only = false)
		{
			// TODO: fix me TESEO
			// Eigen::MatrixXd points;
			// Eigen::MatrixXi tets;
