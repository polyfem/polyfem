...
namespace cppoptlib
{
	...
	template <typename ProblemType>
	void SparseNewtonDescentSolver<ProblemType>::reset(const ProblemType &objFunc, const TVector &x) override
	{
	...
	template <typename ProblemType>
	void SparseNewtonDescentSolver<ProblemType>::update_solver_info() override
	{
