...
namespace miso {
	class P4TriCGV {
		...
		void inherit(const P4TriCGV &parent, unsigned q);
		friend std::ostream &operator<<(std::ostream &out, const P4TriCGV &s);
		...
		P4TriCGV(const P4TriCGV &parent, unsigned q,
		...
		static RealVector<84> CL_m0(const RealVector<15> &p0x, const RealVector<15> &p0y, const RealVector<15> &p1x, const RealVector<15> &p1y);
		static RealVector<84> LB_2p6_1p2(const RealVector<84> &_l);
		...
		static std::array<RealVector<84>, 8> subdiv_0_2p6_1p2(const RealVector<84> &_b);
		static std::array<RealVector<84>, 2> subdiv_1_2p6_1p2(const RealVector<84> &_b);
		template<unsigned SI=0> std::array<P4TriCGV, schemes[SI]> split_impl() const;
	};
