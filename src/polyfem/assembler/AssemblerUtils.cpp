...
#include <polyfem/assembler/local/Bilaplacian.hpp>
#include <polyfem/assembler/local/Helmholtz.hpp>
#include <polyfem/assembler/local/HookeLinearElasticity.hpp>
#include <polyfem/assembler/local/IncompressibleLinElast.hpp>
...
#include <polyfem/assembler/local/MooneyRivlin3ParamSymbolic.hpp>
#include <polyfem/assembler/local/SumModel.hpp>
