...
namespace polyfem::assembler
{
	...
	public:
		...
		void set_materials(const std::vector<int> &body_ids, const json &body_params, const Units &units, const io::ResourceIO &resources);
		virtual void add_multimaterial(const int index, const json &params, const Units &units, const io::ResourceIO &resources) {}
