...
namespace polyfem::solver
{
	...
	// {
	// public:
	// 	TractionNormForm(const VariableToSimulationGroup &variable_to_simulations, const varform::DifferentiableVarForm &varform, const json &args) : SpatialIntegralForm(variable_to_simulations, varform, args)
	// 	{
	...
	// {
	// public:
	// 	TrueContactForceForm(const VariableToSimulationGroup &variable_to_simulations, const varform::DifferentiableVarForm &varform, const json &args) : StaticForm(variable_to_simulations), varform_(varform)
	// 	{
	// 		auto tmp_ids = args["surface_selection"].get<std::vector<int>>();
	// 		ids_ = std::set(tmp_ids.begin(), tmp_ids.end());
	...
	// 	const varform::DifferentiableVarForm &get_varform() { return varform_; }

	// 	double value_unweighted_step(const int time_step, const Eigen::VectorXd &x) const override;
	// 	Eigen::VectorXd compute_adjoint_rhs_step(const int time_step, const Eigen::VectorXd &x, const varform::DifferentiableVarForm &varform) const override;
	// 	Eigen::VectorXd compute_adjoint_rhs_step_prev(const int time_step, const Eigen::VectorXd &x, const varform::DifferentiableVarForm &varform) const override;
	...
	// protected:
	// 	const varform::DifferentiableVarForm &varform_;
	// 	std::set<int> ids_;
