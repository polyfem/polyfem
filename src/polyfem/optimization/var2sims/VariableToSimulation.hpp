...
{
	/// @brief Maps optimization variables to forward simulation varform::VarForm variables.
	...
	public:
		...
		/// @brief Compute optimization variables from forward simulation varform::VarForm.
