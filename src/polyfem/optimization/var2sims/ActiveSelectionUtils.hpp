...
namespace polyfem::solver
{
	...
	/// @brief Validate active geometry nodes selection given varforms.
	/// @param[in] active_geom_nodes Vector of active geometry node indexes. Empty implies all active.
	/// @param[in] varforms Shared ptr to all varforms.
	...
	/// @brief Validate active dimensions selection given varforms.
	...
	/// @brief Validate active solution space dofs selection given varforms.
	/// @param[in] active_dofs Vector of active varform dof indexes. Empty implies all active.
	/// @param[in] varforms Shared ptr to all varforms.
	/// @param[out] reason Reason why validation failed. Set only when invalid.
	...
	/// @brief Validate active time slices selection given varforms.
	...
	/// @brief Validate active Dirichlet boundary ids selection given varforms.
	...
	/// @brief Validate active Dirichlet node ids selection given varforms.
	...
	/// @brief Validate active pressure boundary ids selection given varforms.
