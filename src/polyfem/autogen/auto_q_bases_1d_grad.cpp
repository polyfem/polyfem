...
namespace autogen {
namespace {
void q_0_basis_grad_value_1d_single_0(double x, double *val) {
{val[0] = 0;}
}
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_0_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
...
void q_1_basis_grad_value_1d_single_0(double x, double *val) {
{val[0] = -1.0;}
}

void q_1_basis_grad_value_1d_single_1(double x, double *val) {
{val[0] = 1.0;}
}
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_1_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 1:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_1_basis_grad_value_1d_single_1(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	default: assert(false);
...
void q_2_basis_grad_value_1d_single_0(double x, double *val) {
{val[0] = 4.0*x - 3.0;}
}

void q_2_basis_grad_value_1d_single_1(double x, double *val) {
{val[0] = 4.0 - 8.0*x;}
}

void q_2_basis_grad_value_1d_single_2(double x, double *val) {
{val[0] = 4.0*x - 1.0;}
}
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_2_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 1:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_2_basis_grad_value_1d_single_1(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 2:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_2_basis_grad_value_1d_single_2(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	default: assert(false);
...
void q_3_basis_grad_value_1d_single_0(double x, double *val) {
{val[0] = -13.5*pow(x, 2) + 18.0*x - 5.5;}
}

void q_3_basis_grad_value_1d_single_1(double x, double *val) {
{val[0] = 40.499999999999986*pow(x, 2) - 44.999999999999986*x + 8.9999999999999982;}
}

void q_3_basis_grad_value_1d_single_2(double x, double *val) {
{val[0] = -40.499999999999986*pow(x, 2) + 35.999999999999993*x - 4.4999999999999991;}
}

void q_3_basis_grad_value_1d_single_3(double x, double *val) {
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_3_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 1:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_3_basis_grad_value_1d_single_1(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 2:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_3_basis_grad_value_1d_single_2(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 3:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_3_basis_grad_value_1d_single_3(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	default: assert(false);
...
void q_m2_basis_grad_value_1d_single_0(double x, double *val) {
{val[0] = 4.0*x - 3.0;}
}

void q_m2_basis_grad_value_1d_single_1(double x, double *val) {
{val[0] = 4.0 - 8.0*x;}
}

void q_m2_basis_grad_value_1d_single_2(double x, double *val) {
{val[0] = 4.0*x - 1.0;}
}
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_m2_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 1:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_m2_basis_grad_value_1d_single_1(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 2:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_m2_basis_grad_value_1d_single_2(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	default: assert(false);
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_4_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 1:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_4_basis_grad_value_1d_single_1(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 2:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_4_basis_grad_value_1d_single_2(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 3:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_4_basis_grad_value_1d_single_3(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 4:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_4_basis_grad_value_1d_single_4(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	default: assert(false);
...
void q_5_basis_grad_value_1d_single_3(double x, double *val) {
{val[0] = 1302.0833333333333*pow(x, 4) - 2500.0*pow(x, 3) + 1531.25*pow(x, 2) - 324.99999999999994*x + 16.666666666666664;}
}

void q_5_basis_grad_value_1d_single_4(double x, double *val) {
...
void q_5_basis_grad_value_1d_single_5(double x, double *val) {
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_5_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 1:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_5_basis_grad_value_1d_single_1(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 2:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_5_basis_grad_value_1d_single_2(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 3:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_5_basis_grad_value_1d_single_3(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 4:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_5_basis_grad_value_1d_single_4(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 5:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_5_basis_grad_value_1d_single_5(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	default: assert(false);
...
void q_6_basis_grad_value_1d_single_2(double x, double *val) {
...
void q_6_basis_grad_value_1d_single_3(double x, double *val) {
...
void q_6_basis_grad_value_1d_single_4(double x, double *val) {
...
void q_6_basis_grad_value_1d_single_5(double x, double *val) {
...
void q_6_basis_grad_value_1d_single_6(double x, double *val) {
...
switch(local_index){
	case 0:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_6_basis_grad_value_1d_single_0(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 1:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_6_basis_grad_value_1d_single_1(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 2:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_6_basis_grad_value_1d_single_2(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 3:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_6_basis_grad_value_1d_single_3(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 4:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_6_basis_grad_value_1d_single_4(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 5:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_6_basis_grad_value_1d_single_5(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	case 6:
		for (Eigen::Index i = 0; i < uv.rows(); ++i) {
			q_6_basis_grad_value_1d_single_6(uv(i, 0), gradient);
			val(i, 0) = gradient[0];
		}
		break;
	default: assert(false);
