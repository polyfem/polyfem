...
namespace polyfem
{
	...
	{
		template <int dim>
		void generate_gradient_(const double c1, const double c2, const double c3, const double d1, const Eigen::Matrix<double, dim, dim> &def_grad, Eigen::Matrix<double, dim, dim> &gradient) {}
		template <>
		...
		template <int dim>
		void generate_hessian_(const double c1, const double c2, const double c3, const double d1, const Eigen::Matrix<double, dim, dim> &def_grad, Eigen::Matrix<double, dim * dim, dim * dim> &hessian) {}
		template <>
