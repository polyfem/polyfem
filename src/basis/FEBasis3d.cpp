...
namespace
{
	...
	bool check_edge_face_orders(const polyfem::NCMesh3D &mesh, const Eigen::VectorXi &elem_orders, const Eigen::VectorXi &edge_orders, const Eigen::VectorXi &face_orders)
	{
