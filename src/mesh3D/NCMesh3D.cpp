...
namespace polyfem
{
    ...
    void NCMesh3D::compute_body_ids(const std::function<int(const RowVectorNd &)> &marker)
    {
    ...
    void NCMesh3D::refine_element(int id_full)
    {
        ...
        if (elements[id_full].children(0) >= 0) {
            ...
            // create children
            elements[id_full].children(0) = elements.size(); add_element(Eigen::Vector4i(v1,v5,v6,v7), id_full);
            elements[id_full].children(1) = elements.size(); add_element(Eigen::Vector4i(v5,v2,v8,v9), id_full);
            elements[id_full].children(2) = elements.size(); add_element(Eigen::Vector4i(v6,v8,v3,v10), id_full);
            elements[id_full].children(3) = elements.size(); add_element(Eigen::Vector4i(v7,v9,v10,v4), id_full);
            elements[id_full].children(4) = elements.size(); add_element(Eigen::Vector4i(v5,v6,v7,v9), id_full);
            elements[id_full].children(5) = elements.size(); add_element(Eigen::Vector4i(v5,v9,v8,v6), id_full);
            elements[id_full].children(6) = elements.size(); add_element(Eigen::Vector4i(v6,v7,v9,v10), id_full);
            elements[id_full].children(7) = elements.size(); add_element(Eigen::Vector4i(v6,v10,v9,v8), id_full);
        }
